...
{
    public record GetContractsQuerybackup : IRequest<PaginatedList<ContractDetailsDTO>>
    {
    ...
    public class GetContractsQuerybackupHandler : IRequestHandler<GetContractsQuery, PaginatedList<ContractDetailsDTO>>
    {
        private readonly IApplicationDbContext _context;

        public GetContractsQuerybackupHandler(IApplicationDbContext context)
        {
            _context = context;
        }
