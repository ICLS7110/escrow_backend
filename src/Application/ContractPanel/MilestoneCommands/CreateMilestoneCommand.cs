    ...
    public async Task<Result<object>> Handle(CreateMilestoneCommand request, CancellationToken cancellationToken)
    {
        ...
        if (request?.MileStoneDetails == null || !request.MileStoneDetails.Any())
        {
            return Result<object>.Failure(
                ...
                AppMessages.Get("MilestoneInvaliddetails", language)
            );
        }
        ...
        return Result<object>.Success(
            ...
            AppMessages.Get("MilestonescreatedAndupdated", language),
            milestoneResults
        );
    }
}
...
//        if (request?.MileStoneDetails == null || !request.MileStoneDetails.Any())
//        {
//            return Result<object>.Failure(StatusCodes.Status400BadRequest, AppMessages.MilestoneInvaliddetails);
//        }
...
//        return Result<object>.Success(StatusCodes.Status200OK, AppMessages.MilestonescreatedAndupdated, milestoneResults);
//    }
