...
namespace Escrow.Api.Application.AdminAuth.Queries
{
    ...
    public class GetAdminListingsQueryHandler : IRequestHandler<GetAdminListingsQuery, Result<PaginatedList<AllAdminDetail>>>
    {
        ...
        public GetAdminListingsQueryHandler(IApplicationDbContext context, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        public async Task<Result<PaginatedList<AllAdminDetail>>> Handle(GetAdminListingsQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result<PaginatedList<AllAdminDetail>>.Success(StatusCodes.Status200OK, AppMessages.Get("ListingFetched", language), listings);
        }
    }
}
...
//            return Result<PaginatedList<AllAdminDetail>>.Success(StatusCodes.Status200OK, AppMessages.ListingFetched, listings);
//        }
//    }
