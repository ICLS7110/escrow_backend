...
public class UpdateNotificationCommandHandler : IRequestHandler<UpdateNotificationCommand, Result<bool>>
{
    ...
    public UpdateNotificationCommandHandler(IApplicationDbContext context, IHttpContextAccessor httpContextAccessor)
    {
        _context = context;
    ...
    public async Task<Result<bool>> Handle(UpdateNotificationCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            return Result<bool>.Failure(StatusCodes.Status400BadRequest, AppMessages.Get("InvalidInputIdsMustBeGreaterThanZero", language));
        }
        ...
        {
            return Result<bool>.Failure(StatusCodes.Status404NotFound, AppMessages.Get("NotificationNotFound", language));
        }
        ...
        return Result<bool>.Success(StatusCodes.Status200OK, AppMessages.Get("NotificationUpdatedSuccessfully", language), true);
    }
}
