...
namespace Escrow.Api.Application.TeamsManagement.Queries
{
    ...
    new PaginatedList<TeamDTO>(new List<TeamDTO>(), 0, 1, 10)
        ...
        //                         user
        //                     })
        //     .AsEnumerable() // ✅ bring into memory
        ...
        //        //                ContractId = teamMember.ContractId != null
        //        //    ? teamMember.ContractId.Split(',')
        //        //    : new List<string>(),
        ...
        //        //                    PhoneNumber = PhoneNumberHelper.ExtractPhoneNumberWithoutCountryCode(user.PhoneNumber),
        //        //                    CountryCode = PhoneNumberHelper.ExtractCountryCode(user.PhoneNumber),
        //        //                } : null
        //        //            };
