...
//namespace Escrow.Api.Application.UserPanel.Commands;
//public class UpdateMobileNumberCommand : IRequest<Result<bool>>
//{
//    public string? SocialId { get; set; }
//    public string? CountryCode { get; set; }
//    public string? MobileNumber { get; set; }
...
//public class UpdateMobileNumberCommandHandler : IRequestHandler<UpdateMobileNumberCommand, Result<bool>>
//{
//    private readonly IApplicationDbContext _context;
...
//    public UpdateMobileNumberCommandHandler(
//        IApplicationDbContext context,
//        IOtpManagerService otpManagerService,
//        IOtpValidationService validationService,
//        IOtpService otpService,
//        IMemoryCache cache)
//    {
...
//    public async Task<Result<bool>> Handle(UpdateMobileNumberCommand request, CancellationToken cancellationToken)
//    {
//        if (string.IsNullOrWhiteSpace(request.SocialId) ||
//            string.IsNullOrWhiteSpace(request.CountryCode) ||
//            string.IsNullOrWhiteSpace(request.MobileNumber))
//        {
//            return Result<bool>.Failure(StatusCodes.Status400BadRequest, "Invalid request data.");
//        }
...
//        if (user == null)
//            return Result<bool>.Failure(StatusCodes.Status400BadRequest, "Invalid social login token.");

//        var phoneNumber = $"{request.CountryCode}{request.MobileNumber}";
//        var isPhoneNumberValid = await _validationService.ValidatePhoneNumberAsync(phoneNumber);

//        if (!isPhoneNumberValid)
//            return Result<bool>.Failure(StatusCodes.Status400BadRequest, "Invalid phone number.");
...
//        return Result<bool>.Success(StatusCodes.Status200OK, "OTP has been sent and phone number updated.");
//    }
...
//    //    user.PhoneNumber = (request.CountryCode.StartsWith("+") ? request.CountryCode : $"+{request.CountryCode}") + request.MobileNumber.Replace(" ", "");



//    //    return Result<bool>.Success(StatusCodes.Status200OK, "OTP has been sent to your mobile number.");
...
//    //    var isOtpValid = _otpManagerService.Ge(fullPhone, request.Otp);
//    //    if (!isOtpValid)
//    //        return Result<bool>.Failure(StatusCodes.Status400BadRequest, "Invalid social login token.");
...
//    //    // Optional: log change
//    //    // await _auditService.LogChangeAsync("UpdateMobileNumber", user.UserId, oldData, newData);

//    //    return Result<bool>.Success(StatusCodes.Status200OK, "Mobile Number Update Successfully!!");
//    //}
//}
